  <!-- Jquery JS-->
    ...
    <script src="<?php echo base_url();?>assets/admin/js/cropper/cropper.min.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/cropper/cropper-actice.js"></script>
	<!-- wow JS
		============================================ -->
    ...
    <script src="<?php echo base_url();?>assets/admin/js/calendar/fullcalendar-active.js"></script>
	 ...
	 <!-- code editor JS
		============================================ -->
    <script src="<?php echo base_url();?>assets/admin/js/code-editor/codemirror.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/code-editor/code-editor.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/code-editor/code-editor-active.js"></script>

	 <!-- Tree Viewer JS
		============================================ -->
    <script src="<?php echo base_url();?>assets/admin/js/tree-line/jstree.min.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/tree-line/jstree.active.js"></script>

	 <!-- Google map JS
		============================================ -->
    <script src="<?php echo base_url();?>assets/admin/js/google.maps/google.maps-active.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBiNUO68DkrsFKFz744_LWMqCNI_GqYciQ&callback=initMap"></script>

	 <!-- Data Maps JS
		============================================ -->
    <script src="<?php echo base_url();?>assets/admin/js/data-map/d3.min.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/data-map/topojson.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/data-map/datamaps.all.min.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/data-map/data-maps-active.js"></script>

	 <!-- pdf JS
		============================================ -->
    <script src="<?php echo base_url();?>assets/admin/js/pdf/jquery.media.js"></script>
    <script src="<?php echo base_url();?>assets/admin/js/pdf/pdf-active.js"></script>
